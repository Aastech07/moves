      ...
      <View style={{ flexDirection: 'row', bottom: 450, alignSelf: 'center' }}>
        ...
        <View style={styles.inputView}>
          <TextInput style={styles.inputText}
            ...
            edile={true} onChange={(text)=>setSearchQuery(text)}
             />
        </View>
        <TouchableOpacity>

        <FontAwesome5 size={20} name='search' style={{  position:'absolute',bottom:-10,left:120 }} color={'gray'} />
        </TouchableOpacity>
